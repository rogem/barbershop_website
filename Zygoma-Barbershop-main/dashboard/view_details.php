...
if(isset($_GET['id']) && $_GET['id'] > 0){
    ...
    $qry2 = $conn->query("SELECT * FROM `client_view` where patient_id = '{$patient_id}' ");
...
<div class="container-fluid">
    ...
    <p><b>Client Name:</b> <?php echo $patient['name'] ?></p>
    ...
    <p><b>Hair Cut:</b> <?php echo $patient['haircut'] ?></p>
    <p><b>Hair Treatment:</b> <?php echo $patient['hairtreatment'] ?></p>
    <p><b>Notes:</b> <?php echo $notes ?></p>
    <p><b>Staff:</b> <?php echo $patient['staff'] ?></p>
    <p><b>Total:</b> <?php echo $patient['total'] ?></p>
    <p><b>Status:</b>
        <?php 
        switch($status){ 
            case(0): 
